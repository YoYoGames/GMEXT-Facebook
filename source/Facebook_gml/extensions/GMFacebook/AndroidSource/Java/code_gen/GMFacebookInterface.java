...
public interface GMFacebookInterface {
    ...
    public void fb_graph_request(String graph_path, java.util.List<FacebookHttpMethod> method, java.util.List<FacebookNamedValue> parameters, GMFunction callback);
    public void fb_dialog(String link_url, GMFunction callback);
    public boolean fb_send_event(java.util.List<FacebookAppEvent> event, double value, java.util.List<FacebookEventParameterValue> parameters);
