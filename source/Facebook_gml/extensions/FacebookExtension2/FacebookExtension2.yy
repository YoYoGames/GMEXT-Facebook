{
  ...
  "files":[
    {"$GMExtensionFile":"","%Name":"","constants":[
        ...
        {"$GMExtensionFunction":"","%Name":"fb_login","argCount":0,"args":[2,2,],"documentation":"/// @desc Prompts the user to authorize your application for read permissions using the Login Dialog appropriate to the platform. \r\n/// If the user is already logged in and has authorized your application, checks whether all permissions in the permissions parameter\r\n/// have been granted, and if not, prompts the user for any that are newly requested.\r\n/// @param {Id.DsList<String>} _permissions A list of permissions to be requested when login in.\r\n/// @param {real} _type Unused parameter (will be ignored).","externalName":"fb_login","help":"fb_login(permissions, type)","hidden":false,"kind":4,"name":"fb_login","resourceType":"GMExtensionFunction","resourceVersion":"2.0","returnType":2,},
        ...
        {"$GMExtensionFunction":"","%Name":"fb_graph_request","argCount":0,"args":[1,1,2,],"documentation":"/// @desc Performs a request with a specific graph path, parameters, and HTTP method.\r\n/// @param {String} _graph_path The graph path to retrieve, create, or delete\r\n/// @param {String} _http_method The HTTP method to be used (GET, POST, DELETE).\r\n/// @param {Id.DsList<String>} _params Additional parameters to pass along with the graph request; the format used \r\n/// is [key1, value1, key2, value2, ...] parameter keys must be strings with values being either of type string or number.","externalName":"fb_graph_request","help":"fb_graph_request(graph_path, http_method, params)","hidden":false,"kind":4,"name":"fb_graph_request","resourceType":"GMExtensionFunction","resourceVersion":"2.0","returnType":2,},
        ...
        {"$GMExtensionFunction":"","%Name":"fb_request_read_permissions","argCount":0,"args":[2,],"documentation":"/// @desc Prompts the user to authorize your application for read permissions using the Login Dialog appropriate to the platform. \r\n/// If the user is already logged in and has authorized your application, checks whether all permissions in the permissions parameter\r\n/// have been granted, and if not, prompts the user for any that are newly requested.\r\n/// @param {Id.DsList<String>} _permissions A list of permissions to be requested read capabilities for.","externalName":"fb_request_read_permissions","help":"fb_request_read_permissions(permissions)","hidden":false,"kind":4,"name":"fb_request_read_permissions","resourceType":"GMExtensionFunction","resourceVersion":"2.0","returnType":2,},
        ...
        {"$GMExtensionFunction":"","%Name":"fb_request_publish_permissions","argCount":0,"args":[2,],"documentation":"/// @desc Prompts the user to authorize your application for publish permissions using the Login Dialog appropriate to the platform. \r\n/// If the user is already logged in and has authorized your application, checks whether all permissions in the permissions parameter\r\n/// have been granted, and if not, prompts the user for any that are newly requested.\r\n/// @param {Id.DsList<String>} _permissions A list of permissions to be requested publish capabilities for.","externalName":"fb_request_publish_permissions","help":"fb_request_publish_permissions(permissions)","hidden":false,"kind":4,"name":"fb_request_publish_permissions","resourceType":"GMExtensionFunction","resourceVersion":"2.0","returnType":2,},
        ...
        {"$GMExtensionFunction":"","%Name":"fb_init","argCount":0,"args":[],"documentation":"","externalName":"fb_init","help":"fb_init()","hidden":false,"kind":4,"name":"fb_init","resourceType":"GMExtensionFunction","resourceVersion":"2.0","returnType":2,},
        ...
        {"$GMExtensionFunction":"","%Name":"fb_send_event","argCount":0,"args":[1,2,2,],"documentation":"","externalName":"fb_send_event","help":"fb_send_event(event_id, value_to_sum, params)","hidden":false,"kind":4,"name":"fb_send_event","resourceType":"GMExtensionFunction","resourceVersion":"2.0","returnType":1,},
